...
public class slfParser extends Parser {
	...
	public static final int
		PRINT=17, BECOMES=1, LT=8, COMMENT=36, MINUS=3, DIVIDE=5, SEMICOLON=25, 
		OCURLY=28, ELSE=21, CHARACTER=33, IDENTIFIER=34, WS=37, UNEQUALS=12, IF=19, 
		TYPE=23, CPAREN=27, COMMA=30, NUMBER=35, OR=14, TIMES=4, EQUALS=7, CCURLY=29, 
		MODULO=6, CONSTANT=16, COLON=24, GT=10, BOOLEAN=31, OPAREN=26, READ=18, 
		NOT=15, AND=13, GTE=11, STRING=32, THEN=20, WHILE=22, LTE=9, PLUS=2;
	public static final String[] tokenNames = {
		"<INVALID>", "'='", "'+'", "'-'", "'*'", "'/'", "'%'", "'=='", "'<'", 
		"'<='", "'>'", "'>='", "'!='", "'&&'", "'||'", "'!'", "'constant'", "'print'", 
		"'read'", "'if'", "'then'", "'else'", "'while'", "TYPE", "':'", "';'", 
		"'('", "')'", "'{'", "'}'", "','", "BOOLEAN", "STRING", "CHARACTER", "IDENTIFIER", 
		"NUMBER", "COMMENT", "WS"
	};
	public static final int
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(42); match(OPAREN);
				setState(43); expression(0);
				setState(44); match(CPAREN);
				}
				break;
			case 3:
				{
			...
			case 6:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(49); compound_expression();
				}
				break;
			case 7:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(50); assignment_expression();
				}
				break;
			case 8:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						...
						setState(65); match(AND);
						setState(66); expression(10);
						}
						break;
					case 5:
						{
	...
	public final Read_expressionContext read_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(112); match(READ);
			setState(113); match(OPAREN);
	...
	public final If_expressionContext if_expression() throws RecognitionException {
		...
		try {
			...
			setState(141); compound_expression();
			setState(144);
			switch ( getInterpreter().adaptivePredict(_input,12,_ctx) ) {
			case 1:
				{
				setState(142); match(ELSE);
				setState(143); compound_expression();
				}
				break;
			}
			}
	...
	public static class NumberContext extends LiteralContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof slfListener ) ((slfListener)listener).enterNumber(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof slfListener ) ((slfListener)listener).exitNumber(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof slfVisitor ) return ((slfVisitor<? extends T>)visitor).visitNumber(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CharacterContext extends LiteralContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof slfListener ) ((slfListener)listener).enterCharacter(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof slfListener ) ((slfListener)listener).exitCharacter(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof slfVisitor ) return ((slfVisitor<? extends T>)visitor).visitCharacter(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\b\16\b\u0087\13\b\3\b\3\b\3\t\3\t\3\t\3\t\3\t\3\t\3\t\3\t\5\t\u0093\n"+
		"\t\3\n\3\n\6\n\u0097\n\n\r\n\16\n\u0098\3\n\3\n\3\13\3\13\3\13\3\13\3"+
		"\f\3\f\3\f\3\f\5\f\u00a5\n\f\3\f\2\3\6\r\2\4\6\b\n\f\16\20\22\24\26\2"+
		"\6\4\2\5\5\21\21\3\2\6\b\3\2\4\5\3\2\t\16\u00b7\2\33\3\2\2\2\4\'\3\2\2"+
		"\2\6\67\3\2\2\2\bM\3\2\2\2\np\3\2\2\2\fr\3\2\2\2\16~\3\2\2\2\20\u008a"+
		"\3\2\2\2\22\u0094\3\2\2\2\24\u009c\3\2\2\2\26\u00a4\3\2\2\2\30\32\5\4"+
		"\3\2\31\30\3\2\2\2\32\35\3\2\2\2\33\31\3\2\2\2\33\34\3\2\2\2\34\3\3\2"+
		"\2\2\35\33\3\2\2\2\36\37\5\6\4\2\37 \7\33\2\2 (\3\2\2\2!\"\5\b\5\2\"#"+
		"\7\33\2\2#(\3\2\2\2$%\5\n\6\2%&\7\33\2\2&(\3\2\2\2\'\36\3\2\2\2\'!\3\2"+
		"\2\2\'$\3\2\2\2(\5\3\2\2\2)*\b\4\1\2*+\t\2\2\2+8\5\6\4\17,-\7\34\2\2-"+
		".\5\6\4\2./\7\35\2\2/8\3\2\2\2\608\5\f\7\2\618\5\16\b\2\628\5\20\t\2\63"+
		"8\5\22\n\2\648\5\24\13\2\658\5\26\f\2\668\7$\2\2\67)\3\2\2\2\67,\3\2\2"+
