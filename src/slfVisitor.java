...
public interface slfVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code whileStatementCommand}
	 * labeled alternative in {@link slfParser#command}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWhileStatementCommand(@NotNull slfParser.WhileStatementCommandContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link slfParser#return_expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReturn_expression(@NotNull slfParser.Return_expressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDeclarationCommand(@NotNull slfParser.DeclarationCommandContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExpressionCommand(@NotNull slfParser.ExpressionCommandContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link slfParser#if_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIf_statement(@NotNull slfParser.If_statementContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ifStatementCommand}
	 * labeled alternative in {@link slfParser#command}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfStatementCommand(@NotNull slfParser.IfStatementCommandContext ctx);
	/**
